...
export const ChatPage: React.FC = () => {
  ...
  const handleScroll = () => {
    if (messagesContainerRef.current) {
      ...
      // (Do not auto-clear new message highlights here — keep bubbles sticky even after scrolling.)
      ...
      <main className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden pb-0">
        {!activeConversationId ? (
          ...
          <>
            ...
            {/* Selection toolbar removed from the header - moved to the bottom above filters */}
            ...
            <div 
              className="flex-1 min-h-0 overflow-y-auto p-2 md:p-4 pb-4 md:pb-6 particles-bg relative"
              ref={messagesContainerRef}
              onScroll={handleScroll}
              style={{
                userSelect: selectedMessages.size > 0 ? 'none' : 'auto',
            ...
            <div className="sticky bottom-0 z-20 border-t border-gray-700 bg-gray-800 shadow-2xl p-1.5 sm:p-2 md:p-4 flex-shrink-0 relative">
              ...
              <div
                className="flex items-center gap-2 mb-1.5 sm:mb-2 md:mb-3 sticky z-20 rounded-xl px-2 py-1"
                style={{ top: 'calc(env(safe-area-inset-top, 0px) + 8px)', background: 'rgba(17,24,39,0.85)', backdropFilter: 'blur(12px)' }}
              >
                <div className="relative">
                  <button
                    onClick={() => {
